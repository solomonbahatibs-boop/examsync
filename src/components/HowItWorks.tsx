    ...
    <section id="how-it-works" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-blue-600 font-semibold tracking-wide uppercase text-sm mb-3">Process</h2>
          <p className="text-4xl font-bold text-gray-900 mb-4">How ExamSync Works</p>
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="relative mb-8 inline-block">
                  <div className="w-16 h-16 rounded-full bg-blue-600 text-white flex items-center justify-center text-xl font-bold z-10 relative group-hover:scale-110 transition-transform shadow-lg shadow-blue-200">
                    {step.number}
                  </div>
